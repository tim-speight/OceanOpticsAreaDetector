...
#ifndef OCEANDIRECT_TCPIPV4SOCKETBUS_H
#define OCEANDIRECT_TCPIPV4SOCKETBUS_H
...
namespace oceandirect {
    ...
    public:
        TCPIPv4SocketBus(const std::vector<std::string> &descriptor);
        ...
        virtual TransferHelper *getHelper(const std::vector<ProtocolHint *> &hints) const override;
    ...
    protected:
        ...
        std::vector<std::string> stringDescriptor;
    };
}

#endif /* OCEANDIRECT_TCPIPV4SOCKETBUS_H */
