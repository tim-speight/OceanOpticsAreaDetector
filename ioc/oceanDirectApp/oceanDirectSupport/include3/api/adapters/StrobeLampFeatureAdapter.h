 ...
 * access to OceanDirect StrobeLampFeatureInterface instances.
 */
 /************************************************************************
 *
...
#ifndef OCEANDIRECT_STROBELAMPFEATUREADAPTER_H
#define OCEANDIRECT_STROBELAMPFEATUREADAPTER_H
...
namespace oceandirect {
    namespace api {
        ...
        public:
            ...
            bool getStrobeLampEnable(int *errorCode);
        };
