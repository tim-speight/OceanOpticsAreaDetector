 ...
 * access to OceanDirect ShutterFeatureInterface instances.
 */
 /************************************************************************
 *
...
#ifndef OCEANDIRECT_SHUTTERFEATUREADAPTER_H
#define OCEANDIRECT_SHUTTERFEATUREADAPTER_H
...
namespace oceandirect {
    namespace api {
        ...
        public:
            ...
            bool getShutterState(int* errorCode);
        };
